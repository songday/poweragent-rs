...
const changedModelCategory = (v) => {
  if (v === 'HuggingFace') {
    ...
    modelOptions.splice(
      0,
      modelOptions.length,
      ...allModels.LlmApis[nodeData.llmApiProvider].models,
    )
  }
    ...
    >
      <el-form :label-width="formLabelWidth" :model="nodeData">
        <el-form-item
          ...
          prop="nodeName"
          :rules="[{ required: true, message: 'nodeName is required' }]"
        >
        ...
        <el-form-item
          v-show="nodeData.modelCategory === 'LlmApis'"
          label=""
          :label-width="formLabelWidth"
        >
          <el-select
            v-model="nodeData.llmApiProvider"
            @change="(v) => changedModelCategory('LlmApis')"
          >
        ...
        <el-form-item
          v-show="nodeData.modelCategory === 'Ollama'"
          label="API URL"
          :label-width="formLabelWidth"
        >
        ...
        <el-form-item
          v-show="nodeData.modelCategory !== 'HuggingFace'"
          label="Timeout"
          :label-width="formLabelWidth"
        >
        ...
        >
          <el-input
            v-model="nodeData.responseVarName"
            autocomplete="on"
        ...
        >
          <el-input
            v-model="nodeData.executionTimeMillisVarName"
            autocomplete="on"
            placeholder="Enter a variable name"
          />
        </el-form-item>
